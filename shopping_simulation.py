...
# test_cart = transaction.Cart("jolson@upperlinecode.com")

# 2. You can access the user's email
# print(test_cart.user)
...
# 10. The method total_with_tax should return the total with 8.875% sales tax added on.
# print(test_cart.total_with_tax())